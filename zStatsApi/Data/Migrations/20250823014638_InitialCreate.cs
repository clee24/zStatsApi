        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sets_Teams_WinnerTeamId",
                        column: x => x.WinnerTeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HittingKills = table.Column<int>(type: "integer", nullable: false),
                    HittingErrors = table.Column<int>(type: "integer", nullable: false),
                    HittingAttempts = table.Column<int>(type: "integer", nullable: false),
                    ServiceAces = table.Column<int>(type: "integer", nullable: false),
                    ServiceErrors = table.Column<int>(type: "integer", nullable: false),
                    ServiceAttempts = table.Column<int>(type: "integer", nullable: false),
                    SettingDimes = table.Column<int>(type: "integer", nullable: false),
                    SettingErrors = table.Column<int>(type: "integer", nullable: false),
                    SettingAttempts = table.Column<int>(type: "integer", nullable: false),
                    Blocks = table.Column<int>(type: "integer", nullable: false),
                    Digs = table.Column<int>(type: "integer", nullable: false),
                    Shanks = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlayerStats_Sets_SetId",
                        column: x => x.SetId,
                        principalTable: "Sets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
